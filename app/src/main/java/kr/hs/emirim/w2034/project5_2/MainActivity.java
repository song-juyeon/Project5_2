package kr.hs.emirim.w2034.project5_2;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] btnids = {R.id.btn0, R.id.btn1, R.id.btn1, R.id.btn2, R.id.btn4, R.id.btn5, R.id.btn6, R.id.btn7, R.id.btn8, R.id.btn9};
        ...
        Button btnDevide = findViewById(R.id.btn_divide);
        ...
        btnDevide.setOnClickListener(btnOperationListener);
